        ...
        <div className="md:col-span-9 lg:col-span-9 flex flex-col gap-20 md:gap-24">
          ...
          <motion.div style={{ y: y2, opacity: opacity2 }} className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="font-sans text-xl md:text-2xl lg:text-3xl font-bold leading-tight tracking-tight">
                  SMKN 1 Tanjung Pinang
                </p>
                <p className="font-sans text-xl md:text-2xl lg:text-3xl font-normal text-black/70 leading-tight tracking-tight">
                  Teknik Jaringan dan Komputer (2019–2022)
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div style={{ y: y3, opacity: opacity3 }} className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-6">
              <p className="font-sans text-xl md:text-2xl lg:text-3xl font-normal text-black/70 leading-tight tracking-tight">
                I am a Junior Programmer with a passion for building functional solutions. Starting from networking in SMK, I've transitioned into software development, focusing on backend systems and mobile apps. 
              </p>
              <p className="font-sans text-xl md:text-2xl lg:text-3xl font-normal text-black/70 leading-tight tracking-tight">
                I've built systems like HOMI to solve real property management issues and AI tools to help infrastructure maintenance.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div style={{ y: y4, opacity: opacity4 }} className="flex flex-col gap-2">
            ...
            <ul className="flex flex-col">
              <li className="font-sans text-xl md:text-2xl lg:text-3xl font-bold leading-tight tracking-tight">
                Backend System & Multi-tenant Architecture
              </li>
              <li className="font-sans text-xl md:text-2xl lg:text-3xl font-bold leading-tight tracking-tight">
