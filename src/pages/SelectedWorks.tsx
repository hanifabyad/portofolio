...
const projects = [
  {
    id: "001",
    title: "HOMI: Landing Page",
    stack: "React / TailwindCSS / Vite",
    description: "The official landing page for HOMI, featuring a modern design, service overviews, and resident onboarding information.",
    links: { live: "https://besthomi.online", code: "#" },
    image: "/projects/homi-landing.png",
    cta: "Live Site"
  },
  {
    id: "002",
